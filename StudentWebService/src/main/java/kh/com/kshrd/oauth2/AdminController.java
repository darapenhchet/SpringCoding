...
public class AdminController {
	...
	@RequestMapping(value = "/oauth2/users/{user}/tokens/{token}", method = RequestMethod.DELETE)
	...
	@RequestMapping("/oauth2/clients/{client}/tokens")
	@ResponseBody
