...
public class ImageRestController {
	...
	public ResponseEntity<Map<String, Object>> addNewImage(@RequestParam("file") MultipartFile file, HttpServletRequest request){
		...
		if (!file.isEmpty()) {
            try {
                ...
                String savePath = request.getServletContext().getRealPath("/resources/uploads/");
